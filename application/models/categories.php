...
class Categories extends CI_Model {
	...
	function __construct(){
        ...
        $this->tableName = 'categories';
       	...
       	$this->selectQuery = '	categories.id as id,
                     			categories.name as name,
                   				categories.status as status,
                                categories.created_on as created_on';
    }
	...
	function add(){
    	...
    	$this->data['created_on'] = date('Y-m-d H:i:s');
  		try{
  			...
  			log_message('error', 'Categories::add'.$e->getMessage());
  			return 0;
  		}
    }
    ...
    function edit($id){
        ...
        try{
            ...
            log_message('error', 'Categories::edit'.$e->getMessage());
            return 0;
        }
    }
