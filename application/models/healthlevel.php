<?php
class Healthlevel extends CI_Model {
	
	function __construct(){
        parent::__construct();
        $this->tableName = 'healthlevels';
        
       	$this->selectQuery = '	healthlevels.id as id,
                     			healthlevels.name as name,
                   				healthlevels.status as status,
                                healthlevels.created_on as created_on';
    }
    	...
    	$this->data['created_on'] = date('Y-m-d H:i:s');
  		try{
			...
			return $this->db->insert_id();
  			...
  			log_message('error', 'Healthlevels::add'.$e->getMessage());
  			return 0;
  		}
    }
    ...
    function edit($id){
        ...
        try{
            ...
            log_message('error', 'Healthlevels::edit'.$e->getMessage());
            return 0;
        }
    }
