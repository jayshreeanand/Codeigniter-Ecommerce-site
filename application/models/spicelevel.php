<?php
class Spicelevel extends CI_Model {
	
	function __construct(){
        parent::__construct();
        $this->tableName = 'spicelevels';
        
       	$this->selectQuery = '	spicelevels.id as id,
                     			spicelevels.name as name,
                   				spicelevels.status as status,
                                spicelevels.created_on as created_on';
    }
    	...
    	$this->data['created_on'] = date('Y-m-d H:i:s');
  		try{
			...
			return $this->db->insert_id();
  			...
  			log_message('error', 'Spicelevel::add'.$e->getMessage());
  			return 0;
  		}
    }
    ...
    function edit($id){
        ...
        try{
            ...
            log_message('error', 'Spicelevel::edit'.$e->getMessage());
            return 0;
        }
    }
