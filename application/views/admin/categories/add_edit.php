<?php $this->load->view('admin/header', array('pageTitle' => 'Category Management','cssFiles' =>array())); ?>
...
?>
<div class="row">
	<div id="category" class="span6 offset1">
		<form method="POST" id="category-form"  class="form-horizontal" >
	 		<fieldset>
...
<?php $this->load->view('admin/footer', array('jsFiles' => array('js/vendor/jquery.validate.min.js','js/categories/add-edit.js'))); ?>
