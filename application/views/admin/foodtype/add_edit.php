<?php $this->load->view('admin/header', array('pageTitle' => 'Foodtype Management','cssFiles' =>array())); ?>
<?php $this->load->view('admin/foodtype/menu');?>
...
?>
<div class="row">
	<div id="foodtype" class="span6 offset1">
		<form method="POST" id="foodtype-form"  class="form-horizontal" >
	 		<fieldset>
		    	<legend>Foodtype Details</legend>
			    <div id="foodtype-message" 
...
<?php $this->load->view('admin/footer', array('jsFiles' => array('js/vendor/jquery.validate.min.js','js/foodtype/add-edit.js'))); ?>
