...
<li <?php if($c == 'adminhealthlevel' ){?> class="active" <?php }?>><a href="<?php echo site_url('adminhealthlevel');?>">Health Level</a></li>
<li <?php if($c == 'adminspicelevel' ){?> class="active" <?php }?>><a href="<?php echo site_url('adminspicelevel');?>">Spice Level</a></li>
<li <?php if($c == 'adminfoodtype' ){?> class="active" <?php }?>><a href="<?php echo site_url('adminfoodtype');?>">Food Type</a></li>
